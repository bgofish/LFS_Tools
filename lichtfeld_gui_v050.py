...
class LichtFeldStudioDialog:
    def __init__(self, root):
        self.root = root
        self.root.title("LichtFeld Studio CLI Batch File Generator v0.5 - 3D Gaussian Splatting")
    ...
    def create_training_options(self, parent):
        ...
        training_options = [
            ...
            {"name": "--init", "default": "", "description": "Initialize from splat file (.ply, .sog, .spz, .resume)", "enabled": False},
    ...
    def create_optimization_options(self, parent):
        ...
        optimization_options = [
            {"name": "--strategy", "default": "mcmc", "description": "Optimization strategy: mcmc, adc, igs+", "enabled": False}
        ]
...
# This continues from Part 2 - append this after Part 2
    ...
    def get_option_name_by_index(self, index):
        ...
        all_option_names = [
            ...
            "--resize_factor", "--timelapse-images", "--timelapse-every",
            # Optimization options (18)
            "--strategy",
            # Sparsity & Memory options (19-22)
            "--tile-mode", "--sparsify-steps", "--init-rho", "--prune-ratio",
            # Logging & Masking options (23-26)
            "--log-level", "--log-file", "--log-filter", "--mask-mode"
        ]
