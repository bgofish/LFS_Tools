...
class LichtFeldStudioDialog:
    ...
    def create_options_section(self):
        ...
        tabs = [
            ...
            ("Mask.Opt's",        self._build_mask_options_tab),
    ...
    def _build_training_parameters_tab(self, parent):
        ...
        self._row_check(parent, r, "--use-error-map  — Weight MRNF refine signal by per-pixel SSIM error map",
                        self.use_error_map_var); r += 1
        self._row_check(parent, r, "--use-edge-map  — Weight MRNF refine signal by Sobel edge map on GT images",
                        self.use_edge_map_var); r += 1
    ...
    def _build_rendering_options_tab(self, parent):
        ...
        self._row_dropdown(parent, r, "--tile-mode", v, sv,
                           ["1", "2", "4"],
                           "Tile mode for memory-efficient training (1/2/4 tiles, default: 1)"); r += 1
        ...
        self._row_check(parent, r, "--bg-modulation  — Enable sinusoidal background modulation",
                        self.bg_modulation_var); r += 1
    ...
    def _build_output_options_tab(self, parent):
        ...
        self._row_check(parent, r, "--eval  — Enable evaluation during training",
                        self.eval_var); r += 1
        self._row_check(parent, r, "--save-eval-images  — Save evaluation comparison images (GT vs rendered)",
                        self.save_eval_images_var); r += 1
        self._row_check(parent, r, "--save-depth  — [TODO] Save depth maps during training (not yet implemented)",
                        self.save_depth_var); r += 1
